...
export function Dashboardui() {
   ...
   // data present 
   // if data is present then show the dashboard else show the error page
   const isData = false;

   const handleConnctCloud = () => {
   ...
   return (
      <div className="flex min-h-screen flex-col">
         <header className="flex h-14 items-center gap-4 border-b bg-background px-6">
            ...
            <div className="ml-auto flex items-center gap-4">
               ...
               <Button variant="outline" onClick={handleConnctCloud}>☁️ Add Cloud</Button>
            ...
            <main className="flex-1 space-y-4 p-8 pt-6">
                        ...
                        <div className="mb-4 flex items-center gap-4">
                           ...
                           <DropdownMenu>
                              ...
                              <DropdownMenuContent>
                                 <DropdownMenuItem
                                    onClick={() =>
                                       handleGroupByChange("Cloud provider")
                                    }>
                                    Cloud provider
                                 </DropdownMenuItem>
                                 <DropdownMenuItem
                                    onClick={() =>
                                       handleGroupByChange("Region")
                                    }>
                                    Region
                                 </DropdownMenuItem>
                              </DropdownMenuContent>
               ...
               <Card>
                  <CardHeader>
                     ...
                     <CardDescription>
                        Visualise, understand, and manage your infrastructure
                        costs and usage
                     </CardDescription>
                  </CardHeader>
                  <CardContent>
                     <div className="mb-4 flex flex-wrap items-center gap-4">
                        <DropdownMenu>
                           ...
                           <DropdownMenuContent>
                              <DropdownMenuItem
                                 onClick={() => setGroupBy("Cloud provider")}>
                                 Cloud provider
                              </DropdownMenuItem>
                              <DropdownMenuItem
      ...
      <div className="text-center max-w-md mx-auto">
        ...
        <div className="space-y-4">
          <h1 className="text-xl font-semibold text-gray-900">Configure Cloud Credential</h1>

          <p className="text-gray-500 text-sm leading-relaxed">
            Add a cloud credential by selecting your provider, entering authentication details, validating access, and saving it securely for use.
          </p>

          <div className="pt-4">
            <Button
              variant="outline"
              onClick={handleConnctCloud}
