               ...
               <div className="flex h-full flex-col justify-center px-12">
                  <figure className="space-y-6">
                     <blockquote className="text-2xl font-medium leading-normal italic">
                        "The cloud-agnostic tool provides unified resource
                        management, optimizing multi-cloud costs and efficiency
                        through usage analysis and smart recommendations."
                     </blockquote>
