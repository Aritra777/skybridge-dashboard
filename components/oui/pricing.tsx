...
import { CheckCircle2, XCircle, ChevronRight, Zap, Cloud, Globe } from 'lucide-react'; // Importing icons from lucide-react

// Main App component for the pricing page
const App = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 font-sans text-gray-900 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        {pricingPlans.map((plan, index) => (
          <div
            ...
            className={`
              ...
              ${plan.highlight
                ? 'ring-4 ring-indigo-500 scale-105 z-10 hover:shadow-2xl' // Added hover effect for highlighted card
                : 'ring-1 ring-gray-200 hover:shadow-2xl hover:scale-102' // Existing hover for non-highlighted
              }
            `}
          >
            {plan.highlight && (
            ...
            <a
              ...
              className={`
                ...
                ${plan.highlight
                  ? 'bg-indigo-600 text-white shadow-lg hover:bg-indigo-700 hover:scale-105 hover:shadow-xl' // Enhanced hover for highlighted button
                  : 'bg-blue-100 text-blue-700 ring-2 ring-blue-300 hover:bg-blue-200 hover:scale-102 hover:shadow-md' // Enhanced hover for standard button
                }
              `}
            >
              {plan.buttonText}
      ...
      <div className="mt-20 max-w-4xl w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-2xl shadow-md flex flex-col items-center text-center hover:shadow-lg transition-shadow duration-300 transform hover:scale-105"> {/* Added hover effect for benefit cards */}
            <Zap className="h-10 w-10 text-indigo-500 mb-4 transition-colors duration-300 group-hover:text-indigo-600" /> {/* Added group-hover for icon */}
