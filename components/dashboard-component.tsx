      ...
      <div>
            ...
            <Card>
                        <CardHeader>
                           ...
                           <CardDescription>
                              Visualise, understand, and manage your
                              infrastructure costs and usage
                           </CardDescription>
                        </CardHeader>
                        <CardContent>
            ...
            {/* Error message */}
             <div className="space-y-4">
                           ...
                           <p className="text-gray-500 text-sm leading-relaxed">
                              Add a cloud credential by selecting your provider,
                              entering authentication details, validating
                              access, and saving it securely for use.
                           </p>
